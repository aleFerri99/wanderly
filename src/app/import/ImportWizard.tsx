      ...
      <div className="iw-card">
        ...
        {template?.start_date && (
          <div className="iw-field">
            ...
            <input type="date" value={globalStart} onChange={e => applyGlobalShift(e.target.value)} />
            ...
            <div className="iw-date-row">
              <div className="iw-field iw-field-sm">
                ...
                <input
                  ...
                  onChange={e => setDayDate(idx, 'date', e.target.value)}
                />
              </div>
              <div className="iw-field iw-field-sm">
                ...
                <input
                  ...
                  onChange={e => setDayDate(idx, 'date_end', e.target.value)}
